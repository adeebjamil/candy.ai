...
export default function DiscoverPage() {
  const characters = [
    { id: 1, name: "Sakura", age: 22, isNew: true, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=400&q=80" },
    ...
    { id: 3, name: "Aria", age: 22, isNew: true, image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=400&q=80" },
    { id: 4, name: "Kaito", age: 26, isNew: false, image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=400&q=80" },
    { id: 5, name: "Simona", age: 24, isNew: false, image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=400&q=80" },
    { id: 6, name: "Emma", age: 23, isNew: true, image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&q=80" },
  ];

  const filters = ["All", "Trending", "New", "Popular", "Top Rated"];
    ...
    <div className="flex flex-col flex-1 pb-16 md:pb-24 bg-white min-h-screen">
      ...
      <section className="w-full py-12 md:py-20 px-6 md:px-8 text-center border-b border-border bg-surface/30">
        <h1 className="text-3xl md:text-5xl font-black tracking-tight text-foreground">
          Discover <span className="text-primary">New Connections</span>
        </h1>
      </section>
