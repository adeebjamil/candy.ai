...
export default function LoginPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-60px)] px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute -bottom-8 left-1/3 w-96 h-96 bg-purple-200/40 rounded-full blur-3xl mix-blend-multiply opacity-70 animate-blob animation-delay-4000"></div>
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl border border-white/40 shadow-2xl rounded-3xl p-8 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-foreground mb-2">Welcome Back to CandyAI</h1>
          <p className="text-sm text-gray-500 text-center font-medium">
            Jump back into your virtual world and connect with your favorite companions.
          </p>
        </div>
        ...
        <form className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5 ml-1 mr-1">
              ...
              <Link href="#" className="text-sm font-medium text-primary hover:text-button-secondary transition-colors">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
        ...
        <div className="mt-8 flex items-center justify-center opacity-50">
          ...
          <span className="px-4 text-sm font-medium text-gray-500 whitespace-nowrap">Or continue with</span>
          <div className="w-full h-px bg-gray-300"></div>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-500 font-medium">
          ...
          <Link href="/register" className="text-primary font-bold hover:text-button-secondary transition-colors">
            Sign up
          </Link>
        </p>
      </div>
